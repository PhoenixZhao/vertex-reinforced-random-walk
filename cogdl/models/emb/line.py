...
>>>>>>> a69a969020b8aa41cfcd8ac54511984bc5b32d62:cogdl/models/emb/line.py
...
<<<<<<< HEAD:cogdl/models/line.py
                np.random.random(
                    (self.num_node, self.dimension)) - 0.5) / self.dimension
=======
...
>>>>>>> a69a969020b8aa41cfcd8ac54511984bc5b32d62:cogdl/models/emb/line.py
            ...
            label, target = np.asarray(
                [1 for _ in range(batch_size)]), np.asarray(v)
...
<<<<<<< HEAD:cogdl/models/line.py
                        self.emb_vertex[u],
                        self.emb_vertex[target],
                        vec_error,
                        label)
                else:
                    self._update(
                        self.emb_vertex[u],
                        self.emb_context[target],
                        vec_error,
                        label)
=======
