...
class NetSMF(BaseModel):
    ...
    def build_model_from_args(cls, args):
        return cls(
            ...
            args.negative,
            args.num_round,
<<<<<<< HEAD:cogdl/models/netsmf.py
            args.worker)
=======
            args.worker,
        )
>>>>>>> a69a969020b8aa41cfcd8ac54511984bc5b32d62:cogdl/models/emb/netsmf.py
...
>>>>>>> a69a969020b8aa41cfcd8ac54511984bc5b32d62:cogdl/models/emb/netsmf.py
        ...
        for i in range(self.num_node):
<<<<<<< HEAD:cogdl/models/netsmf.py
            unnormalized_probs = [G[id2node[i]][nbr].get(
                "weight", 1.0) for nbr in G.neighbors(id2node[i])]
            ...
            self.node_weight[i] = dict(
                zip([node2id[nbr] for nbr in G.neighbors(id2node[i])], unnormalized_probs))
...
<<<<<<< HEAD:cogdl/models/netsmf.py
            new_u = self.neighbors[u][alias_draw(
                self.alias_nodes[u][0], self.alias_nodes[u][1])]
            zp += 2.0 / self.node_weight[u][new_u]
            u = new_u
        for j in range(rand_v):
            new_v = self.neighbors[v][alias_draw(
                self.alias_nodes[v][0], self.alias_nodes[v][1])]
=======
...
<<<<<<< HEAD:cogdl/models/netsmf.py
                    matrix[u_, v_] += 2 * r / \
                        self.window_size / self.num_round / zp
=======
